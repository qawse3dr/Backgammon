...
public class GameState {
  ...
  */
  ...
  /*
  Helper function for InitPieceState. Adds nulls to points lists that will have black pieces in them when the game is initialized.
  */
  private List<Piece>[] FillBlackBoard(int i, List<Piece>[] board){
   ...
   /*
  Helper function for InitPieceState. Adds nulls to points lists that will have white pieces in them when the game is initialized.
  */
  ...
  */
  public void AddPieceInit(Piece piece, int verticality) {
    Logger.Debug($"Initializing piece at verticality {verticality} on point {piece.StartPointIndex}");
